      ...
      <main className="flex-grow p-4" style={{ fontSize: `${fontSize}px` }}>
        <div className="bg-white rounded-lg shadow-lg p-8 mx-4 my-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <p className='text-white' onMouseEnter={() => handleHover('Traffic congestion has a significant negative impact on the environment. The large increase in idle time caused by traffic congestion is one of its most obvious effects. In bumper to bumper traffic, cars crawl along with their motors on even when they are not moving. The ecosystem suffers greatly as a result of this extended idle time. Idling causes a cocktail of dangerous chemicals and greenhouse gases to be released into the atmosphere during the burning of fuel. Carbon monoxide (CO), carbon dioxide (CO2), and nitrogen oxides (NOx) are a few of the pollutants emitted while a car is idling. A colorless and odorless gas known as carbon monoxide poses serious health concerns, especially at high concentrations. When cars are left idling for a long time, significant amounts of carbon dioxide, a primary greenhouse gas, are released into the atmosphere. ')}
            onMouseLeave={() => handleLeave()}
            ref={sectionRef}>Traffic congestion has a significant negative impact on the environment. The large increase in idle time caused by traffic congestion is one of its most obvious effects. In bumper to bumper traffic, cars crawl along with their motors on even when they are not moving. The ecosystem suffers greatly as a result of this extended idle time. Idling causes a cocktail of dangerous chemicals and greenhouse gases to be released into the atmosphere during the burning of fuel. Carbon monoxide (CO), carbon dioxide (CO2), and nitrogen oxides (NOx) are a few of the pollutants emitted while a car is idling. A colorless and odorless gas known as carbon monoxide poses serious health concerns, especially at high concentrations. When cars are left idling for a long time, significant amounts of carbon dioxide, a primary greenhouse gas, are released into the atmosphere. </p>
            </section>
